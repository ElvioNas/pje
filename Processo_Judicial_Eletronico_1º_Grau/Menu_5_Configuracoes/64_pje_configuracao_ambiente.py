...
time.sleep(2)
driver.find_element(By.PARTIAL_LINK_TEXT, "Ambiente").click()
time.sleep(2)
driver.find_element(By.XPATH, "//a[contains(text(), 'Jobs da aplicação')]")
time.sleep(2)
driver.find_element(By.XPATH, "//a[contains(text(), 'Reindexar processos')]")
time.sleep(1000)