...
contar(By.PARTIAL_LINK_TEXT, "Painel de expedientes", "click")
...
contar(By.XPATH, "//label[contains(text(), ' Mostrar expedientes já impressos? ')]")

contar(By.XPATH,"//div[contains(text(), 'Meus Expedientes')]")

contar(By.XPATH, "//form[contains(text(), 'Número do Processo')]")

contar(By.XPATH, "//form[contains(text(), 'Expediente')]")

contar(By.XPATH, "//form[contains(text(), 'Urgente')]")

contar(By.XPATH, "//form[contains(text(), 'Data de Cadastro do Expediente')]")

contar(By.XPATH, "//form[contains(text(), 'Destinatário')]")

contar(By.XPATH, "//form[contains(text(), 'Imprimir')]")

contar(By.XPATH, "//form[contains(text(), 'Impresso?')]")
