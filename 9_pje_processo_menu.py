...
driver.find_element(By.XPATH, "//a[contains(text(), 'Novo processo com Jus Postulandi')]")
driver.find_element(By.XPATH, "//a[contains(text(), 'Nova liquidação e execução trabalhista')]")
driver.find_element(By.XPATH, "//a[contains(text(), 'Não protocolado')]")
driver.find_element(By.XPATH, "//a[contains(text(), 'Importar processo do Judwin 1º Grau')]")
